...
namespace StreamlinkGtk {
	namespace Interfaces {
		namespace Providers {
			...
			public interface IProviderPlugin : GLib.Object {
				...
				public abstract StreamlinkGtk.Interfaces.Providers.IWelcomeWindowContents welcome_window_contents { get; set; }
			...
			[CCode (cheader_filename = "lib_streamlink_gtk_shared.h")]
			public interface IWelcomeWindowContents : Adw.Bin {
	...
	namespace Models {
		...
		[CCode (cheader_filename = "lib_streamlink_gtk_shared.h")]
		public class KeyValue : GLib.Object {
	...
	namespace Services {
		...
		public class ApiRequest : GLib.Object {
			public GLib.SList<StreamlinkGtk.Models.KeyValue> default_request_headers;
			public ApiRequest (string api_base_url);
			public async string? get_request_async (string uri, bool log_response = false);
			public async string? post_request_async (string uri, GLib.SList<StreamlinkGtk.Models.KeyValue>? post_data = null, bool log_response = false);
