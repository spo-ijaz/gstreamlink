...
namespace StreamlinkGtk.Preferences {
    ...
    [GtkTemplate (ui = "/org/gnome/gstreamlink/widgets/preferences/provider-preferences.ui")]

    public class ProviderPreferences : PreferencesPage {

        [GtkChild]
        public unowned Adw.ComboRow combo_row_provider;
        [GtkChild]
        public unowned Adw.Bin selected_provider_preferences;
        [GtkChild]
        ...
        construct {
            ...
            this.selected_provider_preferences.set_child (this.provider_plugin_controller.provider.get_preferences ());
        }

        public ProviderPreferences (ProviderPluginController provider_plugin_controller) {
